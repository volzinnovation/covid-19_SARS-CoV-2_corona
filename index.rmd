...
df$percapita = round(df$max/df$percapita/10, digits=2)
```
...
kable(df,     
     ...
     col.names=c("Country", "Current Cases", "Future Cases (1)", "Total Cases", "Infected Population % (2)"))
```
_Notes:_
...
2. Infected Population refers to the share of reported cases wrt. total population of the country and does not include patients that were not reported or asymptomatic. 
