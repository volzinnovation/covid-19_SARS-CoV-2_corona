...
abline(v=as.Date(round(dsm_ago$midPoint2_x * 2, digits=0), origin=format(DE$Date[1],"%Y-%m-%d")), lty=4, col="orange")
...
| End of first wave | `r as.Date(round(doubleSigmoidalModel$midPoint2_x * 2, digits=0), origin=format(DE$Date[1],"%Y-%m-%d"))` (Day `r round(doubleSigmoidalModel$midPoint2_x * 2, digits=0)`) | `r as.Date(round(dsm_ago$midPoint2_x * 2, digits=0), origin=format(DE$Date[1],"%Y-%m-%d"))` (Day `r round(dsm_ago$midPoint2_x * 2, digits=0)`)              | `r round(doubleSigmoidalModel$midPoint2_x * 2, digits=0) -round(dsm_ago$midPoint2_x * 2, digits=0)`   |
