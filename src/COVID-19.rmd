...
abline(v=DE$Date[round(doubleSigmoidalModel$midPoint1_x, digits=0)][1], col="red")
abline(v=DE$Date[round(doubleSigmoidalModel$maximum_x, digits=0)][1], lwd=2, col="red")
abline(v=DE$Date[round(doubleSigmoidalModel$midPoint2_x, digits=0)][1], col="red")
```
