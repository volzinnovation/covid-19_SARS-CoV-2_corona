...
country = ifelse(exists("country"),country,"Switzerland")
...
I_max_dsm = ifelse( a_d > 0 , dsm_cum[ t_max ] +  2 * ( dsm_cum[t_d] - dsm_cum[ t_max ]) , -1 ) # not really fixed asymptote, -1 if there is no recovery yet
